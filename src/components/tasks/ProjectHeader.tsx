...
export function ProjectHeader({ entry, onUpdate }: ProjectHeaderProps) {
  ...
  return (
    ...
    >
      <label className="flex items-center gap-2">
        <span className="text-muted-foreground text-xs">Task folder</span>
        <Input
      ...
      />
      <label className="flex items-center gap-2">
        <span className="text-muted-foreground text-xs">Default view</span>
        <Input
